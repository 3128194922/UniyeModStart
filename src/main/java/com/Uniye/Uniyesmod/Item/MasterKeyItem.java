...
public class MasterKeyItem extends DiggerItem {
    public MasterKeyItem(float attackDamageIn, float attackSpeedIn, Tier tier, TagKey<Block> mineable, Item.Properties builder)
    {
        super(attackDamageIn, attackSpeedIn, tier, mineable , builder);
    }
